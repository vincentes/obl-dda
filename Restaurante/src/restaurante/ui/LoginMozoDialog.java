 ...
 * @author vincentes
 */
public class LoginMozoDialog extends javax.swing.JDialog implements VLogin {
     ...
     */
    public LoginMozoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Login Mozos");
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        controlador.loginMozo(usuario.getText(), password.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginMozoDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoginMozoDialog dialog = new LoginMozoDialog(new javax.swing.JFrame(), true);
