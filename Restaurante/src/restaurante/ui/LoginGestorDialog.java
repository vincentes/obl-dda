 ...
 * @author vincentes
 */
public class LoginGestorDialog extends javax.swing.JDialog implements VLogin {
     ...
     */
    public LoginGestorDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Login Gestor");
        setLocationRelativeTo(null);
        controlador = new CLogin(this);
        modo = ModoSistema.GESTOR;
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(login, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)))
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        controlador.loginGestor(usuario.getText(), password.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginGestorDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoginGestorDialog dialog = new LoginGestorDialog(new javax.swing.JFrame(), true);
    ...
    public void login(Mozo usr) {
        dispose();
        new MozoVentana(usr).setVisible(true);
    }
